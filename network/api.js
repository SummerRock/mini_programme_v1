...
module.exports = {
  ...
  articleList: ApiRootUrl + 'article/list/$1/json?page_size=$2', //首页文章列表 
  ...
  search: ApiRootUrl + 'article/query/$1/json?page_size=$2', //搜索
  ...
  selfCollect: ApiRootUrl + 'lg/collect/list/$1/json?page_size=$2', //自己收藏
